...
Citizen.CreateThread(function()
	...
	while not HasModelLoaded("a_c_shepherd") do
		RequestModel("a_c_shepherd")
		Citizen.Wait(100)
	end	
...
RegisterCommand("+k9follow", function(source, args, rawCommand)
...
RegisterCommand("+k9Vehicle", function(source, args, rawCommand)
	TriggerEvent("K9::Vehicle")
end, false)

RegisterCommand("+k9Hunt", function(source, args, rawCommand)
	TriggerEvent("K9::Huntfind")
end, false)

RegisterCommand("+k9funny", function(source, args, rawCommand)
...
--K9 Menu (not used)
RegisterNetEvent('K9:funny')
AddEventHandler('K9:funny', function()
	TriggerEvent('k9:funny')
...
RegisterNetEvent("K9:Pet")
AddEventHandler("K9:Pet", function()
	ClearPedTasks(current_dog)
